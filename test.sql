...
DROP TABLE IF EXISTS `accountinfodb`;
...
(2,'Bob',210,'11111@111.com','11111111'),
(3,'Charlie',300,'22222@222.com','22222222');
...
(1,1,1,2,'2020-09-14 07:48:34',10),
(2,2,1,2,'2020-09-14 07:48:34',10);

/* Procedure structure for procedure `account_register` */

/*!50003 DROP PROCEDURE IF EXISTS  `account_register` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `account_register`(In username_ VARCHAR(50), In pwd_ VARCHAR(100), IN email_ VARCHAR(100), iN cellphone_ VARCHAR(100),OUT result_reg int)
label:begin
...
/*!50003 DROP PROCEDURE IF EXISTS  `display_info` */;
...
/*!50003 DROP PROCEDURE IF EXISTS  `exe_transaction` */;
...
/*!50003 DROP PROCEDURE IF EXISTS  `tran_detail` */;
